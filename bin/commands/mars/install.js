...
module.exports = {
    ...
    desc: 'Installs an application from MARS on Cloudflow',
    builder: function(yargs) {
        yargs
            .example('$0 mars install myapp', 'installs the MARS application the id "myapp"')
            .option('host', {
    ...
    handler: function(argv) {
        ...
        mars.install(appName, JSON.parse(JSON.stringify(options)), outputStream).then(function() {
            if (argv.json === true) {
