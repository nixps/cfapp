...
// commander
//   .version('0.0.1')
//   .command('cloudflow <command>', 'install one or more packages')
//   .action(function(args) {
//       console.log(args);
//   })
//   .command('config <command>', 'search with optional query')
//   .command('app <command>', 'list packages installed', {isDefault: true})
//   .parse(process.argv);
