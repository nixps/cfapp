...
var el = require('../node_modules/msi-packager/lib/hyperxml')
  ...
  return el('Wix', {
    ...
    el('Product', {
      ...
      options.runAfter ? el('CustomAction', {
        ...
        ExeCommand: "/c \"\"%programfiles%\\" + options.name + "\\" + options.executable + "\"\"",
        Execute: "",
        Property: "cmd",
        Impersonate: "yes"
      }) : "",
      ...
      el('CustomAction', {
        Id: "UninstallApplication",
        ExeCommand: "/c \"\"%programfiles%\\" + options.name + "\\uninstall.bat" + "\"\"",
        Execute: "",
        Property: "cmd",
        Impersonate: "yes"
      }),
