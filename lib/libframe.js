    ...
    install:    function(argv) {
        ...
        if (adobe.illustrator.installed==false) {
            ...
            try {
                ...
                _cloudflow.copyResource(argv.software_folder+'FrameClient.aip',adobe.illustrator.plugins_folder,false);
                _cloudflow.copyResource(argv.software_folder+'CEPExtensions'+os.slash+"Hybrid_Frame_1.0.0",adobe.illustrator.plugins_folder+"Hybrid_Frame_1.0.0",true);
            } catch(error) {
                console.error(error);
    ...
    uninstall:  function() {
        ...
        if (adobe.illustrator.installed==false) {
            ...
            try {
                ...
                _cloudflow.removeResource(adobe.illustrator.plugins_folder+"Hybrid_Frame_1.0.0");
            } catch(error) {
                console.error(error);
