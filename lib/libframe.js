...
module.exports = {
    ...
    install: function (argv) {
        ...
        var fs = require('fs');
        if(adobe.illustrator.running) {
            console.error("Adobe Illustrator is running.");
        }
        else if (adobe.illustrator.installed == false) {
            ...
            try {
                ...
                adobe.illustrator.versions.forEach(version_obj => {
                    ...
                    if (parseInt(version_obj.version) < 2020) {
                        ai_bin_version = "2017";
                    } else if (parseInt(version_obj.version) == 2020) {
                        ai_bin_version = "2020";
                    } else {
                        ai_bin_version = "2021";
                    }
